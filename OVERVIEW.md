...
**Multi-Model Support**: Choose from 16 Workers AI models ranging from fast 8B parameter models to high-capability 70B models.
...
One-click deployment via the "Deploy to Cloudflare" button, or:
